...
JAVA_OPTS="-Djava.library.path=/jsr/dist/hdf-java/lib/linux -Dlog4j.debug=false -Dlog4j.configuration=ds3.log4j.config.dev.xml -cp target/ds3-1.0-SNAPSHOT-jar-with-dependencies.jar"
