...
public class EodDataProviderMock extends EodDataProviderBase implements
		EodDataProvider {

	@SuppressWarnings("unused")
	private static final transient Logger logger = Logger
			.getLogger(EodDataProviderMock.class);

	private UnitTestData testData = null;

	public EodDataProviderMock(UnitTestData testData)
