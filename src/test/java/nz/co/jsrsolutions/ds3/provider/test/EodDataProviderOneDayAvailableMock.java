...
public class EodDataProviderOneDayAvailableMock extends EodDataProviderBase
		implements EodDataProvider {

	@SuppressWarnings("unused")
	private static final transient Logger logger = Logger
			.getLogger(EodDataProviderOneDayAvailableMock.class);

	private UnitTestData testData = null;

	public EodDataProviderOneDayAvailableMock(UnitTestData testData)
	...
	public QUOTE[] getQuotes(String exchange, String symbol,
		...
		int sourceBeginIndex = Arrays.binarySearch(testData.getQuotes(), key,
				comparator);
		...
		int sourceEndIndex = Arrays.binarySearch(testData.getQuotes(), key,
				comparator);
		...
		System.arraycopy(testData.getQuotes(), sourceBeginIndex, quotes, 0,
				count);
