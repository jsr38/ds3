...
class EodDataProviderOneDayAvailableMock extends EodDataProviderBase implements EodDataProvider {

  @SuppressWarnings("unused")
  private static final transient Logger logger = Logger.getLogger(EodDataProviderOneDayAvailableMock.class);

  private UnitTestData testData = null;

  public EodDataProviderOneDayAvailableMock(UnitTestData testData) throws EodDataProviderException {
